 ...
 render() {
    return(
        <div className="contentsContainer">
            ...
            <h2>Shinto is polytheistic and revolves around the KAMI, supernatural entities believed to inhabit all things. The link between the kami and the natural world has led to Shinto being considered animistic. The kami are worshiped at kamidana household shrines, family shrines, and jinja public shrines.</h2>
